...
void Cell::drawFloor(){
	...
	glTexCoord2f(-1,0.0);glVertex3i(this->getBottomWall().p1.x,this->getBottomWall().p1.y,this->getBottomWall().p1.z);
	glTexCoord2f(1,0.0);glVertex3i(this->getBottomWall().p2.x,this->getBottomWall().p2.y,this->getBottomWall().p2.z);
	glTexCoord2f(1,1);glVertex3i(this->getUpWall().p1.x,this->getUpWall().p1.y,this->getUpWall().p1.z);
	glTexCoord2f(-1,1);glVertex3i(this->getUpWall().p2.x,this->getUpWall().p2.y,this->getUpWall().p2.z);
